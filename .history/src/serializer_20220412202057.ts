import { bin2num, mvc, num2bin } from './utils';

const Script = mvc.Script;
const Opcode = mvc.Opcode;
...
export function deserializeState(s: string | mvc.Script, schema: State | StateArray = undefined): OpStateArray | State | StateArray {
