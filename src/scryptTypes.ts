import {
  parseLiteral, getValidatedHexString, LibraryEntity, intValue2hex, flatternStruct, typeOfArg, isInteger, StructEntity, mvc, checkStructField,
...
export class ScryptType {
  ...
  toHex(): string {
    return mvc.Script.fromASM(this._asm).toHex();
  }
...
export class SigHashPreimage extends ScryptType {
  ...
  private getReader(buf: Buffer) {
    return new mvc.encoding.BufferReader(buf);
  }
