...
describe('utils', () => {
  ...
  describe('num2bin() & bin2num()', () => {
    ...
    it('UInt256 with 32ytes', () => {
      const bn = new BN('0100000000002000010000000000200001000000000020000100000000002000', 16, 'le')
      expect(num2bin(bn, 32)).to.equal('0100000000002000010000000000200001000000000020000100000000002000')
      expect(bin2num('0100000000002000010000000000200001000000000020000100000000002000').toString()).to.equal(
        bn.toString(),
      )
    })
  ...
  describe('int2Asm()', () => {
    it('int string to asm', () => {
      ...
      expect(int2Asm('-1')).to.equal('OP_1NEGATE')

      expect(int2Asm('0')).to.equal('OP_0')

      expect(int2Asm('1')).to.equal('OP_1')

      expect(int2Asm('-2')).to.equal('82')
    })
  })
  ...
  describe('asm2int()', () => {
    it('asm string to int', () => {
      ...
      expect(asm2int('OP_1')).to.equal(1)

      expect(asm2int('OP_0')).to.equal(0)

      expect(asm2int('OP_1NEGATE')).to.equal(-1)

      expect(asm2int('82')).to.equal(130)
    })
  })
  ...
  describe('parseLiteral()', () => {
    it('parser Literal string', () => {
      ...
      expect(
        parseLiteral('PrivKey(0x3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062)'),
      ).to.have.members([
      ...
      expect(
        parseLiteral("PubKey(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')"),
      ).to.have.members([
  ...
  describe('literal2ScryptType()', () => {
    it('literal2ScryptType', () => {
      ...
      expect(
        literal2ScryptType('PrivKey(0x3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062)').toLiteral(),
      ).to.equal('PrivKey(0x3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062)')

      expect(literal2ScryptType("b'62f0245bb9'").value).to.equal('62f0245bb9')

      expect(
        literal2ScryptType("PubKey(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')").value,
      ).to.equal('3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')
      expect(
        literal2ScryptType("PubKey(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')").toLiteral(),
      ).to.equal("PubKey(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')")

      expect(
        literal2ScryptType("Sig(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')").value,
      ).to.equal('3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')
      expect(
        literal2ScryptType("Sig(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')").toLiteral(),
      ).to.equal("Sig(b'3847f126769a6c65d281d925f9ff990f431d19c8c314f9180def0ab95b24f062')")

      expect(literal2ScryptType("Ripemd160(b'3847f126769a6c65d281d925f9ff99')").value).to.equal(
        '3847f126769a6c65d281d925f9ff99',
      )
      expect(literal2ScryptType("Ripemd160(b'3847f126769a6c65d281d925f9ff99')").toLiteral()).to.equal(
        "Ripemd160(b'3847f126769a6c65d281d925f9ff99')",
      )

      expect(literal2ScryptType("Sha1(b'3847f126769a6c65d281d925f9ff99')").value).to.equal(
        '3847f126769a6c65d281d925f9ff99',
      )
      expect(literal2ScryptType("Sha1(b'3847f126769a6c65d281d925f9ff99')").toLiteral()).to.equal(
        "Sha1(b'3847f126769a6c65d281d925f9ff99')",
      )

      expect(literal2ScryptType("Sha256(b'3847f126769a6c65d281d925f9ff99')").value).to.equal(
        '3847f126769a6c65d281d925f9ff99',
      )
      expect(literal2ScryptType("Sha256(b'3847f126769a6c65d281d925f9ff99')").toLiteral()).to.equal(
      ...
      expect(literal2ScryptType("SigHashType(b'01')").toLiteral()).to.equal("SigHashType(b'01')")

      expect(literal2ScryptType("SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')").value).to.equal(
        '3847f126769a6c65d281d925f9ff99',
      )
      expect(literal2ScryptType("SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')").toLiteral()).to.equal(
        "SigHashPreimage(b'3847f126769a6c65d281d925f9ff99')",
      )

      expect(literal2ScryptType("OpCodeType(b'01')").value).to.equal('01')
      expect(literal2ScryptType("OpCodeType(b'01')").toLiteral()).to.equal("OpCodeType(b'01')")
    ...
    describe('compileContract ackermann.scrypt without sourcemap', () => {
      ...
      before(() => {
        const Ackermann = buildContractClass(
          compileContract(getContractFilePath('ackermann.scrypt'), {
            out: tmpdir(),
            sourceMap: false,
          }),
        )
  ...
  describe('toLiteral() ', () => {
    it('toLiteral should returns right', () => {
      expect(toLiteral(new PrivKey('111111111111111111111111111111111111111111'))).to.be.equal(
        'PrivKey(111111111111111111111111111111111111111111)',
      )
      expect(toLiteral(new PrivKey('111111111111111111111111111111111111111111'))).to.be.equal(
        'PrivKey(111111111111111111111111111111111111111111)',
      )
      expect(toLiteral(new PrivKey('0x111111111111111111111111111111111111111111'))).to.be.equal(
        'PrivKey(0x111111111111111111111111111111111111111111)',
      )
      expect(toLiteral(new PrivKey(111111111111111111111111111111111111111111n))).to.be.equal(
        'PrivKey(0x014686b59ab3939851acf5c2e071c71c71c7)',
      )
      expect(toLiteral(new PrivKey(0x111111111111111111111111111111111111111111n))).to.be.equal(
        'PrivKey(0x111111111111111111111111111111111111111111)',
      )
      expect(toLiteral(new PrivKey(24942961277114076470676221145024563535461248733457n))).to.be.equal(
        'PrivKey(0x111111111111111111111111111111111111111111)',
      )
      expect(toLiteral(new PrivKey('24942961277114076470676221145024563535461248733457'))).to.be.equal(
        'PrivKey(24942961277114076470676221145024563535461248733457)',
      )

      expect(toLiteral(new Int('111111111111111111111111111111111111111111'))).to.be.equal(
        '111111111111111111111111111111111111111111',
      )
      expect(toLiteral(new Int('0x111111111111111111111111111111111111111111'))).to.be.equal(
        '0x111111111111111111111111111111111111111111',
      )
      expect(toLiteral(new Int(111111111111111111111111111111111111111111n))).to.be.equal(
        '111111111111111111111111111111111111111111',
      )
      expect(toLiteral(new Int(0x111111111111111111111111111111111111111111n))).to.be.equal(
        '24942961277114076470676221145024563535461248733457',
      )
      expect(toLiteral(new Int(24942961277114076470676221145024563535461248733457n))).to.be.equal(
        '24942961277114076470676221145024563535461248733457',
      )
      expect(toLiteral(new Int('24942961277114076470676221145024563535461248733457'))).to.be.equal(
        '24942961277114076470676221145024563535461248733457',
      )
  ...
  describe('flatternParams() ', () => {
    ...
    it('flattern struct', () => {
      expect(
        flatternParams([{ name: 'a', type: 'StatesA' }], Counter.resolver)
          .map((a) => a.name)
          .join(' '),
      ).to.be.equal('a.states[0].counter a.states[0].done a.states[1].counter a.states[1].done a.hex')

      expect(
        flatternParams([{ name: 'a', type: 'States' }], Counter.resolver)
          .map((a) => a.name)
          .join(' '),
      ).to.be.equal('a.counter a.done')
    })
    ...
    it('flattern array', () => {
      ...
      expect(
        ...
        'a[0].states[0].counter a[0].states[0].done a[0].states[1].counter a[0].states[1].done a[0].hex a[1].states[0].counter a[1].states[0].done a[1].states[1].counter a[1].states[1].done a[1].hex b c',
      )
    })
    ...
    it('flattern alias', () => {
      expect(
        ...
        'a.age a.name a.token b[0].age b[0].name b[0].token b[1].age b[1].name b[1].token b[2].age b[2].name b[2].token',
      )

      expect(
        flatternParams([{ name: 'a', type: 'Tokens[2]' }], Alias.resolver)
          .map((a) => a.name)
          .join(' '),
  ...
  describe('flattenSha256() ', () => {
    it('flattern data', () => {
      expect(flattenSha256(1)).to.be.equal('4bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a')

      expect(flattenSha256(11111)).to.be.equal('5b915ddcebcd384637b13712bb52dc4deaa4b1ce2951aeb34ae61db66dfba9f9')

      expect(flattenSha256(new Bytes(''))).to.be.equal(
        'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
      )

      expect(flattenSha256(false)).to.be.equal('e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855')
      expect(flattenSha256(0)).to.be.equal('e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855')

      expect(flattenSha256(true)).to.be.equal('4bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a')

      expect(flattenSha256([1, 2, 3, 0])).to.be.equal(
        '8b6f70403ba37d5b70d867904b81fbe60056fed2a9e6e1bb21670e79381a6c10',
      )
      expect(flattenSha256([new Int(1), new Int(2), new Int(3), new Int(0)])).to.be.equal(
        '8b6f70403ba37d5b70d867904b81fbe60056fed2a9e6e1bb21670e79381a6c10',
      )
      ...
      expect(flattenSha256(person)).to.be.equal('46fb1bc7b9494a2cd2ebac253782c0fdbe2a00a146417b8ab3503fdaa29209ef')

      expect(flattenSha256([person, person])).to.be.equal(
        '3a51045a7c808a07675b298a383e6d2dbf1c26416b53443dee0941ea4eddca45',
      )
      ...
      expect(toData(map).toHex()).to.be.equal(
        '',
      )
    })
  })
  ...
  describe('findKeyIndex() ', () => {
    it('findKeyIndex data', () => {
      ...
      map.set(42, 77)
      map.set(546, 77)
      expect(findKeyIndex(map, 66)).to.be.equal(5)

      expect(findKeyIndex(map, 546)).to.be.equal(6)

      expect(findKeyIndex(map, 11111)).to.be.equal(-1)
    })
  })

  describe('isGenericType() ', () => {
    it('isGenericType', () => {
      expect(isGenericType('AA<D>')).to.be.true
      expect(isGenericType('AA<D, a>')).to.be.true

      expect(isGenericType('A<Da, da>')).to.be.true

      expect(isGenericType('ST1<ST0<int>>')).to.be.true

      expect(isGenericType('ST1<ST0<int>[3],ST0<int, [3]>[3]>')).to.be.true
    })

    it('parseGenericType', () => {
      expect(parseGenericType('HashedMap<int, int>')).to.deep.eq(['HashedMap', ['int', 'int']])

      expect(parseGenericType('HashedMap<int, bytes>')).to.deep.eq(['HashedMap', ['int', 'bytes']])

      expect(parseGenericType('Mylib< int, bool >')).to.deep.eq(['Mylib', ['int', 'bool']])

      expect(parseGenericType('LL<int, ST1>')).to.deep.eq(['LL', ['int', 'ST1']])

      expect(parseGenericType('ST0<ST0<int,int>,int>')).to.deep.eq(['ST0', ['ST0<int,int>', 'int']])

      //dont allow space
      expect(() => parseGenericType('Mylib <int, bool>')).to.throw('"Mylib <int, bool>" is not generic type')
    })

    it('isGenericType', () => {
      expect(isGenericType('HashedMap<int, int>')).to.be.true

      expect(isGenericType('HashedMap<ST, int[3][3]>')).to.be.true

      expect(isGenericType('HashedMap<ST[3], int[3][3]>')).to.be.true

      expect(isGenericType('HashedMap<ST[3], int[3][3]')).to.be.false
    ...
    it('test hash256', () => {
      ...
      expect(hash256('01')).to.be.eq('9c12cfdc04c74584d787ac3d23772132c18524bc7ab28dec4219b8fc5b425f70')
    })

    it('test sha256', () => {
      // bytes s = hash256(b'01');
      expect(sha256('01')).to.be.eq('4bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a')
    })

    it('test hash160', () => {
      //bytes s = hash160(b'01');
      expect(hash160('01')).to.be.eq('c51b66bced5e4491001bd702669770dccf440982')
    })

    it('test buildOpreturnScript', () => {
      expect(buildOpreturnScript('0011').toHex()).to.be.eq('006a020011')

      expect(buildOpreturnScript('').toHex()).to.be.eq('006a00')
    })

    it('test buildPublicKeyHashScript', () => {
      expect(buildPublicKeyHashScript(new Ripemd160('e1c396944f470d717e6041b0bfb95378d22110ce')).toHex()).to.be.eq(
        '76a914e1c396944f470d717e6041b0bfb95378d22110ce88ac',
      )
    })
  })
  ...
  describe('inferrTypes() ', () => {
    it('test inferrTypes', () => {
      expect(inferrType(1)).to.eq('int')

      expect(inferrType(true)).to.eq('bool')

      expect(inferrType('11')).to.eq('int')

      expect(inferrType(new Bytes(''))).to.eq('bytes')
      ...
      expect(() => inferrType([1, true])).to.throw(
        'cannot inferr type from [1,true] , not all element types are the same',
      )

      expect(() => inferrType([[1, 3], [1]])).to.throw(
        'cannot inferr type from [1,3,1] , not all length of element are the same',
      )
    })
  })
  ...
  describe('parseAbiFromUnlockingScript() ', () => {
    it('test parseAbiFromUnlockingScript when contract only have one public function', () => {
      ...
      expect(parseAbiFromUnlockingScript(p2pkh, fn.toHex())).to.deep.eq({
        type: 'function',
        name: 'unlock',
        index: 0,
        params: [
    ...
    it('test parseAbiFromUnlockingScript when contract only have multiple public function', () => {
      ...
      expect(parseAbiFromUnlockingScript(mdArray, fn.toHex())).to.deep.eq({
        type: 'function',
        name: 'unlockX',
        index: 4,
  ...
  describe('bitwise', () => {
    ...
    it('should succeed', () => {
      // &
      expect(and(new Int(0), new Int(0)).toNumber()).to.eq(0)

      expect(and(new Int(1), new Int(0)).toNumber()).to.eq(0)

      expect(and(new Int(1), new Int(1)).toNumber()).to.eq(1)
      ...
      // |
      expect(or(new Int(0), new Int(0)).toNumber()).to.eq(0)

      expect(or(new Int(1), new Int(0)).toNumber()).to.eq(1)

      expect(or(new Int(1), new Int(1)).toNumber()).to.eq(1)
      ...
      expect(xor(new Int(0), new Int(0)).toNumber()).to.eq(0)

      expect(xor(new Int(1), new Int(0)).toNumber()).to.eq(1)

      expect(xor(new Int(1), new Int(1)).toNumber()).to.eq(0)
      ...
      expect(invert(new Int(-2142284617)).toNumber()).to.eq(5199030)

      expect(invert(new Int(0)).toNumber()).to.eq(0)

      expect(invert(new Int(1)).toNumber()).to.eq(-126)

      expect(invert(new Int(-1)).toNumber()).to.eq(126)

      expect(invert(new Int(-2)).toNumber()).to.eq(125)
      ...
      expect(and(bigL, bigR).toNumber()).to.eq(bigV.toNumber())
