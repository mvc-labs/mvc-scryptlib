...
import { compileContract, compileContractAsync, mvc, toHex, signTx } from '../src/utils'
...
describe('compile()', () => {
  ...
  it('compile with stdout successfully', () => {
    ...
    const privateKey = mvc.PrivateKey.fromRandom('testnet')
